...
class Network:
    ...
    def __call__(self, input_spikes):
        output_spikes = torch.zeros((input_spikes.shape[0], self.layers[-1].output_dimension))
...
class LIFLayer(nn.Module):
    ...
    """
    def __init__(self, n_neurons, weights, voltage_tau=100, synapse_tau=50, spiking_threshold=1.0):
    ...
    def forward(self, input_spikes):
        ...
        # integrate currents
        self.voltages += self.synapses.sum(dim=0) - output_spikes*self.spiking_threshold
